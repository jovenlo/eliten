...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch(`https://bjcwyyifoklzvtfcxjnz.supabase.co/rest/v1/products?id=eq.${productId}`, {
        headers: {
            'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJqY3d5eWlmb2tsenZ0ZmN4am56Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ2MjM3MTQsImV4cCI6MjA2MDE5OTcxNH0.S3TAzmjSqE9VZkoUEdRMCVivpKmA0DEmN1rH9RqofFQ',
            'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJqY3d5eWlmb2tsenZ0ZmN4am56Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ2MjM3MTQsImV4cCI6MjA2MDE5OTcxNH0.S3TAzmjSqE9VZkoUEdRMCVivpKmA0DEmN1rH9RqofFQ'
        }
    })
            ...
            productDetails.innerHTML = `
                ...
                <div class="product-info">
                    ...
                    <div class="product-buttons">
                        ...
                        <button onclick="window.location.href='collection.html'" class="back-btn">
                            Back to Collection
                        </button>
                    </div>
                </div>
